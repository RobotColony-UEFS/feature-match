...
while(quantidadeImagens<=13):
	...
	cv2.imwrite("../resultados/fast-brief/img"+str(quantidadeImagens)+".jpg", img3)
	...
	valor = ("Fast-Brief"+str(quantidadeImagens), len(matches), acertos, "img"+str(quantidadeImagens)+".jpg")
...
valor2 = ("fast_brief", media_matches, desvio_matches, media_corretos, desvio_corretos, porcentagem)
