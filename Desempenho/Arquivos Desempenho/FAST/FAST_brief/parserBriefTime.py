...
while(nImg <= 13):
	...
	while(teste <= 10):
		...
		timeTotal.append(float(linhas[25][2]))
		l9.append(float(linhas[33][3]))
		l11.append(float(linhas[35][3]))
		l12.append(float(linhas[36][3]))
		l13.append(float(linhas[37][3]))
		l15.append(float(linhas[39][3]))
		l16.append(float(linhas[40][3]))
		l18.append(float(linhas[42][3]))
		l20.append(float(linhas[44][3]))
		l21.append(float(linhas[45][3]))
		l22.append(float(linhas[46][3]))
...
arquivo = open('FAST_brief_Time.txt','w')
arquivo.write("FAST_brief \n")
